...
<!-- Address supplemental materials / OSF links, etc.  -->
<!-- Fix Table 3  -->
<!-- Change writing on Bayes True Negative. Because I used an oracle prior setup, true negative rates actually look great -->
...
<!-- Emphasize that there is no bias correction available for the ISP. Also emphasize that the ISP is the only procedure that is *not* median unbiased. Check if Lakens' comment makes this point? -->
...
<!-- Here's some examples on how SBFs are used in practice https://github.com/nicebread/BFDA/blob/master/BFDA_examples.md  -->
