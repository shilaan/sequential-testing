---
title             : "Group-Wise Sequential Hypothesis Testing"
...
gs = function(proc, return = "n") {
  ...
  # Add binding futility bounds and the different rates
...
<!-- Add writing on the combination of fixed sample NHST and equivalence test. -->
<!-- Rephrase decision wording for the Fixed Sample Test combined with equivalence test: refer to rejecting the null, rejecting the alternative, and inconclusive. -->
<!-- Rewrite settings for O'Brien-Fleming: look after 50%, 75%, 100%. -->
<!-- Add writing on the implemented bias corrections for GS designs - median unbiased ES from rpact -->
<!-- Add writing on naive effect size estimate Bayes -->
<!-- Change writing modified SBF prior from Stefan et al. 2020 - informed normal distribution centered on the population effect size (mean 0.5, variance 0.3).  -->
<!-- Explain oracle prior setup: the population effect size is equal to the mode of the prior distribution on effect size in the alternative model [@stefan2020:p.15]  -->
<!-- In this paper, the example we use throughout looks at the performance of these procedures under ideal conditions (an oracle prior setup), i.e. the performance of these procedures when the true effect size matches the model expectations as closely as possible: the population effect size is either equal to zero or it matches the effect size parameter (SPRT, Fixed, GS-designs) or the mode of the prior distribution on effect size (SBF) in the alternative model [@stefan2020: p. 15].  -->
