...
<!-- List recommendations: for OBF, set unequally spaced looks. For SBF, run simulations to choose an optimal sample size, decision threshold, and prior distribution. -->
...
<!-- Emphasize that there is no bias correction available for the ISP, while there is for the SBF and GS.  -->
