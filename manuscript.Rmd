...
\noindent
```{r, fig.heigth = 4.72, fig.width = 6}
knitr::include_graphics("figures/figure7b.tiff", dpi = 300)
```
...
knitr::include_graphics("figures/figure8b.tiff", dpi = 300)
```
...
\noindent
```{r, fig.heigth = 20}
knitr::include_graphics("appendix/figures/figureA1.tiff", dpi = 1200)
```
